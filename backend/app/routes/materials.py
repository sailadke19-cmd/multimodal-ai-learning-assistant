...
async def upload(
    ...
    summary = await ai_service.generate_summary(extracted, language)
    notes   = await ai_service.generate_notes(extracted, language)
    topics  = await ai_service.generate_topics(extracted)
